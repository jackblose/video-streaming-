...
async def start(client, message):
    buttons = [
        [
            InlineKeyboardButton('⚙️ Update Channel', url='https://t.me/wysupportinfo'),
            InlineKeyboardButton('💝 Donate', url='https://t.me/enjoyyourmilk')
        ],
        [
...
async def repo_(client, message):
    buttons = [
        [
            InlineKeyboardButton('✨ Join Now', url='https://t.me/temanesiaonline'),
            InlineKeyboardButton('⚙️ Update Channel', url='https://t.me/wysupportinfo'),
